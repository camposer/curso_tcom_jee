...
public class PersonaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("	</style>");
		pw.println("	<script>");
		pw.println("		var modificar = function() {");
		...
		pw.println("				<input type='submit' name='btnAgregar' value='Agregar'>");
		pw.println("				<input type='button' value='Modificar' onclick='modificar()'>");
		pw.println("			</td>");
		pw.println("		</tr>");
		pw.println("	</table>");
		pw.println("	</form>");
